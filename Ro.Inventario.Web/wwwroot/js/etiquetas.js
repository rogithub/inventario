...
var Etiquetas = /** @class */ (function () {
    ...
    Etiquetas.prototype.borrar = function (p) {
        var self = this;
        self.lines.remove(p);
    };
    Etiquetas.prototype.bind = function () {
        var self = this;
        binderService_1.BinderService.bind(self, "#etiquetasPage");
    };
    return Etiquetas;
}());
__webpack_unused_export__ = Etiquetas;
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [712], () => (__webpack_require__(356)))
